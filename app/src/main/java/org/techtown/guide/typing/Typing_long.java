...
public class Typing_long extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        touchLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AppConstants.TYPING_L_ifValue = false;
            }
        });
    }
    ...
    protected void change_quest() {
        ...
        randomNum = random.nextInt(AppConstants.typing_longs.length);
        quizText = AppConstants.typing_longs[randomNum];
